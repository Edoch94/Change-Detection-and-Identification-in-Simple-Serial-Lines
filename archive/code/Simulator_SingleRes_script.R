...
pt_distr[[11]] <- function(){return(rlnorm(n = 1, meanlog = process_param$`11`[1], sdlog = process_param$`11`[2]))}
pt_distr[[12]] <- function(){return(rlnorm(n = 1, meanlog = process_param$`12`[1], sdlog = process_param$`12`[2]))}
