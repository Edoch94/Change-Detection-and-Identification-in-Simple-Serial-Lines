...
# 330
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[330]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 9.5, 7, 7, 7)
))
q_lim_test_LIST[[330]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 331
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[331]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 11, 7, 7, 7)
))
q_lim_test_LIST[[331]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 332
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[332]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 12.5, 7, 7, 7)
))
q_lim_test_LIST[[332]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 333
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[333]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 8, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[333]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 334
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[334]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 9.5, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[334]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 335
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[335]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 11, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[335]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 336
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[336]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 8, 7, 7)
))
q_lim_test_LIST[[336]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 337
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[337]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 9.5, 7, 7)
))
q_lim_test_LIST[[337]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 338
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[338]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 11, 7, 7)
))
q_lim_test_LIST[[338]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 339
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[339]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 7.5, 7, 7, 7)
))
q_lim_test_LIST[[339]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 340
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[340]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 6, 7, 7, 7)
))
q_lim_test_LIST[[340]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 341
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[341]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 4.5, 7, 7, 7)
))
q_lim_test_LIST[[341]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 342
# Riduzione tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[342]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 6, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[342]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 343
# Riduzione tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[343]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 4.5, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[343]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 344
# Riduzione tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[344]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 6, 7, 7)
))
q_lim_test_LIST[[344]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 345
# Riduzione tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[345]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 4.5, 7, 7)
))
q_lim_test_LIST[[345]] <- matrix(byrow = T, ncol = 7, c(
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000),
  c(10000, 10000, 10000, 10000, 10000, 10000, 10000)
))
...
# 346
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[346]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 9.5, 7, 7, 7)
))
q_lim_test_LIST[[346]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 347
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[347]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 11, 7, 7, 7)
))
q_lim_test_LIST[[347]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 348
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[348]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 12.5, 7, 7, 7)
))
q_lim_test_LIST[[348]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 349
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[349]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 8, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[349]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 350
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[350]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 9.5, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[350]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 351
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[351]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 11, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[351]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 352
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[352]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 8, 7, 7)
))
q_lim_test_LIST[[352]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 353
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[353]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 9.5, 7, 7)
))
q_lim_test_LIST[[353]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 354
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[354]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 11, 7, 7)
))
q_lim_test_LIST[[354]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 355
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[355]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 7.5, 7, 7, 7)
))
q_lim_test_LIST[[355]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 356
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[356]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 6, 7, 7, 7)
))
q_lim_test_LIST[[356]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 357
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[357]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 4.5, 7, 7, 7)
))
q_lim_test_LIST[[357]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 358
# Riduzione tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[358]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 6, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[358]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 359
# Riduzione tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[359]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 4.5, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[359]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 360
# Riduzione tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[360]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 6, 7, 7)
))
q_lim_test_LIST[[360]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 361
# Riduzione tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[361]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 4.5, 7, 7)
))
q_lim_test_LIST[[361]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 3, 3, 3)
))
...
# 362
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[362]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 9.5, 7, 7, 7)
))
q_lim_test_LIST[[362]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 363
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[363]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 11, 7, 7, 7)
))
q_lim_test_LIST[[363]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 364
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[364]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 12.5, 7, 7, 7)
))
q_lim_test_LIST[[364]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 365
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[365]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 8, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[365]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 366
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[366]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 9.5, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[366]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 367
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[367]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 11, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[367]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 368
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[368]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 8, 7, 7)
))
q_lim_test_LIST[[368]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 369
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[369]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 9.5, 7, 7)
))
q_lim_test_LIST[[369]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 370
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[370]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 11, 7, 7)
))
q_lim_test_LIST[[370]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 371
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[371]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 7.5, 7, 7, 7)
))
q_lim_test_LIST[[371]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 372
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[372]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 6, 7, 7, 7)
))
q_lim_test_LIST[[372]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 373
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[373]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 4.5, 7, 7, 7)
))
q_lim_test_LIST[[373]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 374
# Riduzione tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[374]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 6, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[374]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 375
# Riduzione tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[375]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 4.5, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[375]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 376
# Riduzione tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[376]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 6, 7, 7)
))
q_lim_test_LIST[[376]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 377
# Riduzione tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[377]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 4.5, 7, 7)
))
q_lim_test_LIST[[377]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 378
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[378]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 9.5, 7, 7, 7)
))
q_lim_test_LIST[[378]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 379
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[379]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 11, 7, 7, 7)
))
q_lim_test_LIST[[379]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 380
# Aumento tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[380]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 12.5, 7, 7, 7)
))
q_lim_test_LIST[[380]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 381
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[381]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 8, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[381]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 382
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[382]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 9.5, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[382]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 383
# Aumento tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[383]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 11, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[383]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 384
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[384]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 8, 7, 7)
))
q_lim_test_LIST[[384]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 385
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[385]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 9.5, 7, 7)
))
q_lim_test_LIST[[385]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 386
# Aumento tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[386]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 11, 7, 7)
))
q_lim_test_LIST[[386]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 387
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[387]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 7.5, 7, 7, 7)
))
q_lim_test_LIST[[387]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 388
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[388]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 6, 7, 7, 7)
))
q_lim_test_LIST[[388]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 389
# Riduzione tempo di processo: buffer illimitato; cdb in corrispondenza
delay_ind_test_LIST[[389]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 4.5, 7, 7, 7)
))
q_lim_test_LIST[[389]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 390
# Riduzione tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[390]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 6, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[390]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 391
# Riduzione tempo di processo: buffer illimitato; cdb a valle
delay_ind_test_LIST[[391]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 4.5, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[391]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 392
# Riduzione tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[392]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 6, 7, 7)
))
q_lim_test_LIST[[392]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
# 393
# Riduzione tempo di processo: buffer illimitato; cdb a monte
delay_ind_test_LIST[[393]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 4.5, 7, 7)
))
q_lim_test_LIST[[393]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 10, 10, 10)
))
...
##### Gruppo 34 #####
# 394
# Aumento limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[394]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[394]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 6, 3, 3, 3)
))
...
# 395
# Aumento limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[395]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[395]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 10, 3, 3, 3)
))
...
# 396
# Aumento limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[396]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[396]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 20, 3, 3, 3)
))

# 397
# Aumento limite buffer; cdb a valle
delay_ind_test_LIST[[397]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[397]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 6, 3, 3, 3, 3)
))
...
# 398
# Aumento limite buffer; cdb a valle
delay_ind_test_LIST[[398]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[398]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 10, 3, 3, 3, 3)
))
...
# 399
# Aumento limite buffer; cdb a valle
delay_ind_test_LIST[[399]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[399]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 20, 3, 3, 3, 3)
))

# 400
# Aumento limite buffer; cdb a monte
delay_ind_test_LIST[[400]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[400]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 6, 3, 3)
))
...
# 401
# Aumento limite buffer; cdb a monte
delay_ind_test_LIST[[401]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[401]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 10, 3, 3)
))
...
# 402
# Aumento limite buffer; cdb a monte
delay_ind_test_LIST[[402]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[402]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 20, 3, 3)
))

# 403
# Riduzione limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[403]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[403]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 1, 3, 3, 3)
))

# 404
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[404]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[404]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 1, 3, 3, 3, 3)
))
...
# 405
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[405]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[405]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 3, 3, 3, 3),
  c(3, 3, 3, 3, 1, 3, 3)
))
...
# 406
# Aumento limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[406]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[406]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 10, 6, 6, 6)
))
...
# 407
# Aumento limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[407]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[407]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 20, 6, 6, 6)
))
...
# 408
# Aumento limite buffer; cdb a valle
delay_ind_test_LIST[[408]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[408]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 10, 6, 6, 6, 6)
))
...
# 409
# Aumento limite buffer; cdb a valle
delay_ind_test_LIST[[409]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[409]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 20, 6, 6, 6, 6)
))
...
# 410
# Aumento limite buffer; cdb a monte
delay_ind_test_LIST[[410]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[410]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 10, 6, 6)
))
...
# 411
# Aumento limite buffer; cdb a monte
delay_ind_test_LIST[[411]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[411]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 20, 6, 6)
))
...
# 412
# Riduzione limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[412]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[412]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 3, 6, 6, 6)
))
...
# 413
# Riduzione limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[413]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[413]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 1, 6, 6, 6)
))
...
# 414
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[414]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[414]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 3, 6, 6, 6, 6)
))
...
# 415
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[415]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[415]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 1, 6, 6, 6, 6)
))
...
# 416
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[416]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[416]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 3, 6, 6)
))
...
# 417
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[417]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[417]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 1, 6, 6)
))
...
# 418
# Aumento limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[418]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[418]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 20, 10, 10, 10)
))
...
# 419
# Aumento limite buffer; cdb a valle
delay_ind_test_LIST[[419]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[419]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 20, 10, 10, 10, 10)
))
...
# 420
# Aumento limite buffer; cdb a monte
delay_ind_test_LIST[[420]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[420]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 20, 10, 10)
))
...
# 421
# Riduzione limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[421]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[421]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 6, 10, 10, 10)
))

# 422
# Riduzione limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[422]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[422]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 3, 10, 10, 10)
))
...
# 423
# Riduzione limite buffer; cdb in corrispondenza
delay_ind_test_LIST[[423]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[423]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 1, 10, 10, 10)
))

# 424
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[424]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[424]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 6, 10, 10, 10, 10)
))

# 425
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[425]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[425]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 3, 10, 10, 10, 10)
))

# 426
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[426]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 8.5, 7, 7)
))
q_lim_test_LIST[[426]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 1, 10, 10, 10, 10)
))

# 427
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[427]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[427]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 6, 10, 10)
))

# 428
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[428]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[428]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 3, 10, 10)
))

# 429
# Riduzione limite buffer; cdb a valle
delay_ind_test_LIST[[429]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[429]] <- matrix(byrow = T, ncol = 7, c(
  c(10, 10, 10, 10, 10, 10, 10),
  c(10, 10, 10, 10, 1, 10, 10)
))

##### Gruppo 37 #####
# 430
# Sistema per mostrare l'effetto di decoupling creato da un buffer con alta capacità
delay_ind_test_LIST[[430]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 14, 7, 7)
))
q_lim_test_LIST[[430]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 300, 6, 6, 6, 6),
  c(6, 6, 300, 6, 6, 6, 6)
))
...
# 431
# Sistema per mostrare l'effetto di decoupling creato da un buffer con alta capacità
delay_ind_test_LIST[[431]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 14, 7, 7)
))
q_lim_test_LIST[[431]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 600, 6, 6, 6, 6),
  c(6, 6, 600, 6, 6, 6, 6)
))
...
# 432
# Sistema per mostrare l'effetto di decoupling creato da un buffer con alta capacità
delay_ind_test_LIST[[432]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 7, 8.5, 7, 7), 
  c(7, 7, 7, 7, 14, 7, 7)
))
q_lim_test_LIST[[432]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 900, 6, 6, 6, 6),
  c(6, 6, 900, 6, 6, 6, 6)
))

# 433
# Sistema per mostrare il comportamento di blocking e starving in linee più o meno bilanciate
delay_ind_test_LIST[[433]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 7, 8.5, 7, 7, 7), 
  c(7, 7, 7, 8.5, 7, 7, 7)
))
q_lim_test_LIST[[433]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 434
# Sistema per mostrare il comportamento di blocking e starving in linee più o meno bilanciate
delay_ind_test_LIST[[434]] <- matrix(byrow = T, ncol = 7, c(
  c(5, 5, 5, 8.5, 5, 5, 5), 
  c(5, 5, 5, 8.5, 5, 5, 5)
))
q_lim_test_LIST[[434]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 435
# Sistema per mostrare il comportamento di blocking e starving in linee più o meno bilanciate
delay_ind_test_LIST[[435]] <- matrix(byrow = T, ncol = 7, c(
  c(3, 3, 3, 8.5, 3, 3, 3), 
  c(3, 3, 3, 8.5, 3, 3, 3)
))
q_lim_test_LIST[[435]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))

# 436
# Sistema per mostrare il comportamento di blocking e starving negli stage fra il changing e il cdb
delay_ind_test_LIST[[436]] <- matrix(byrow = T, ncol = 7, c(
  c(5.5, 5.5, 5.5, 5.5, 8.5, 5.5, 5.5), 
  c(5.5, 5.5, 6.5, 5.5, 8.5, 5.5, 5.5)
))
q_lim_test_LIST[[436]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 437
# Sistema per mostrare il comportamento di blocking e starving negli stage fra il changing e il cdb
delay_ind_test_LIST[[437]] <- matrix(byrow = T, ncol = 7, c(
  c(5.5, 5.5, 5.5, 5.5, 8.5, 5.5, 5.5), 
  c(5.5, 5.5, 7.5, 5.5, 8.5, 5.5, 5.5)
))
q_lim_test_LIST[[437]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 438
# Sistema per mostrare il comportamento di blocking e starving negli stage fra il changing e il cdb
delay_ind_test_LIST[[438]] <- matrix(byrow = T, ncol = 7, c(
  c(5.5, 5.5, 5.5, 5.5, 8.5, 5.5, 5.5), 
  c(5.5, 5.5, 8.5, 5.5, 8.5, 5.5, 5.5)
))
q_lim_test_LIST[[438]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 439
# Sistema per mostrare il comportamento di blocking e starving negli stage fra il changing e il cdb
delay_ind_test_LIST[[439]] <- matrix(byrow = T, ncol = 7, c(
  c(5.5, 5.5, 5.5, 5.5, 8.5, 5.5, 5.5), 
  c(5.5, 5.5, 9.5, 5.5, 8.5, 5.5, 5.5)
))
q_lim_test_LIST[[439]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 440
# Sistema per mostrare il comportamento di blocking e starving negli stage fra il changing e il cdb
delay_ind_test_LIST[[440]] <- matrix(byrow = T, ncol = 7, c(
  c(5.5, 5.5, 8.5, 5.5, 5.5, 5.5, 5.5), 
  c(5.5, 5.5, 8.5, 5.5, 6.5, 5.5, 5.5)
))
q_lim_test_LIST[[440]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 441
# Sistema per mostrare il comportamento di blocking e starving negli stage fra il changing e il cdb
delay_ind_test_LIST[[441]] <- matrix(byrow = T, ncol = 7, c(
  c(5.5, 5.5, 8.5, 5.5, 5.5, 5.5, 5.5), 
  c(5.5, 5.5, 8.5, 5.5, 7.5, 5.5, 5.5)
))
q_lim_test_LIST[[441]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 442
# Sistema per mostrare il comportamento di blocking e starving negli stage fra il changing e il cdb
delay_ind_test_LIST[[442]] <- matrix(byrow = T, ncol = 7, c(
  c(5.5, 5.5, 8.5, 5.5, 5.5, 5.5, 5.5), 
  c(5.5, 5.5, 8.5, 5.5, 8.5, 5.5, 5.5)
))
q_lim_test_LIST[[442]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 443
# Sistema per mostrare il comportamento di blocking e starving negli stage fra il changing e il cdb
delay_ind_test_LIST[[443]] <- matrix(byrow = T, ncol = 7, c(
  c(5.5, 5.5, 8.5, 5.5, 5.5, 5.5, 5.5), 
  c(5.5, 5.5, 8.5, 5.5, 9.5, 5.5, 5.5)
))
q_lim_test_LIST[[443]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))
...
# 444
# Sistema per mostrare il comportamento di blocking e starving negli stage fra il changing e il cdb
delay_ind_test_LIST[[444]] <- matrix(byrow = T, ncol = 7, c(
  c(5.5, 5.5, 8.5, 5.5, 5.5, 5.5, 5.5), 
  c(5.5, 5.5, 8.5, 5.5, 9.5, 5.5, 5.5)
))
q_lim_test_LIST[[444]] <- matrix(byrow = T, ncol = 7, c(
  c(6, 6, 6, 6, 6, 6, 6),
  c(6, 6, 6, 6, 6, 6, 6)
))

# 445
# Sistema per mostrare l'impossibiltà di detection di un cambiamento dei limiti del buffer quando i limiti iniziali sono già molto alti
delay_ind_test_LIST[[445]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[445]] <- matrix(byrow = T, ncol = 7, c(
  c(20, 20, 20, 20, 20, 20, 20),
  c(20, 20, 20, 20, 15, 20, 20)
))

# 446
# Sistema per mostrare l'impossibiltà di detection di un cambiamento dei limiti del buffer quando i limiti iniziali sono già molto alti
delay_ind_test_LIST[[446]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[446]] <- matrix(byrow = T, ncol = 7, c(
  c(20, 20, 20, 20, 20, 20, 20),
  c(20, 20, 20, 20, 30, 20, 20)
))

# 447
# Sistema per mostrare l'impossibiltà di detection di un cambiamento dei limiti del buffer quando i limiti iniziali sono già molto alti
delay_ind_test_LIST[[447]] <- matrix(byrow = T, ncol = 7, c(
  c(7, 7, 8.5, 7, 7, 7, 7), 
  c(7, 7, 8.5, 7, 7, 7, 7)
))
q_lim_test_LIST[[447]] <- matrix(byrow = T, ncol = 7, c(
  c(20, 20, 20, 20, 20, 20, 20),
  c(20, 20, 20, 20, 10, 20, 20)
))
