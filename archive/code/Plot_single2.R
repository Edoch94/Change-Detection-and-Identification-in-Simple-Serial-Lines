...
model_list <- list (
  list(
    "Model447_n10000_inter10_chv5000_rep30_w100f100"
    ,"Model446_n10000_inter10_chv5000_rep30_w100f100"
  )
)
...
##### Stampa data_in #####
data_in %<>% filter(Activity %in% 1:7)
...
plot_name <- paste0("BufferIncrease8",
                    "_",plot_subtitle,
                    ".pdf")
